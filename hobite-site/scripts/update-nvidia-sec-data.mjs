...
const outputDir = path.join(projectRoot, "app", "research", "nvidia-complete-fundamental-analysis");
...
export const NVIDIA_QUARTERLY_FINANCIALS = ${JSON.stringify(rows,null,2)} satisfies NvidiaQuarterlyFinancial[];
...
export const NVIDIA_VALUATION_HISTORY: NvidiaValuationHistory[] = ${JSON.stringify(rows,null,2)};
